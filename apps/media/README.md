...
> **Status: Placeholder** — Media applications currently run on the Docker host (`10.0.10.20`, bare metal NUC), not on the Kubernetes cluster. See [docker/](../../docker/) for the Docker-based media stack.
>
