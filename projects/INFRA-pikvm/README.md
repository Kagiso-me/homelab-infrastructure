...
| Part | Notes |
|---|---|
| bran Zero 2W | USB OTG native — no extra USB hub needed |
...
- [ ] Document which machine it's connected to in `bran/README.md`

---

## Related

- [bran setup](../../bran/README.md)
